...
var T = {
  ...
  en: {
    ...
    splash1:'🔮 Future know of ready is being...',
    splash2:'⭐ Planets of position check is being...',
    splash3:'✨ Kundli ready is being...',
    splash_subtitle:'Vedic Astrology of exact union',
    hero_tagline:'✨ Planet · Star · Kundli · Future-Result ✨',
    hero_btn:'My Future See (Free)',
    loading_text:'🔮 Bhavishya Dekho — Future build is...',
    loading_subtext:'Planets of position of analysis is happening',
    pay_title:'💳 Payment do',
    pay_btn:'🔐 Safe Payment do',
    pay_methods:'All payment methods accept are',
    pay_secure_short:'100% Safe Payment — Payment done then service instant get!',
    pay_processing:'Payment process going...',
    pay_once:'✦ All payments one time of are',
    pay_norefund:'✦ Report generate after refund not will-be',
    nav_home:'Home', nav_daily:'Daily Horoscope', nav_monthly:'Monthly Horoscope',
    nav_yearly:'Yearly Horoscope', nav_matching:'Kundli Match',
    nav_gemstones:'Gem Advice', nav_remedies:'Remedy',
    nav_history:'My Reports (History)', nav_premium:'Premium Plan',
    nav_about:'Our About', nav_contact:'Contact do',
    nav_privacy:'Privacy Policy', nav_terms:'Rule and Conditions',
    nav_disclaimer:'Disclaimer', nav_backup:'History Backup',
    fc_love_title:'Love Calculator', fc_love_desc:'Love of percent know', fc_love_price:'Free',
    fc_horo_title:'Daily Horoscope', fc_horo_desc:'Today of Future-Result', fc_horo_price:'Free',
    ...
    prem_member_text:'You Premium Member are',
    disclaimer_text:'⚠️ This Future-Result Vedic Astrology on based is. Important Decisions for Expert from Advice take.',
    form_name_ph:'Your Name write', form_place_ph:'Birth Place enter',
    form_love_ph:'Your Name', form_partner_ph:"Partner of Name",
    form_horo_ph:'Your Name write',
    gender_male:'Male', gender_female:'Female', gender_other:'Other',
    rashi_ph:'-- Your Zodiac choose --',
    kundli_basic_buy:'in Report buy',
    kundli_prem_buy:'in Premium Report buy',
    upsell_basic:'Detailed Kundli', upsell_prem:'Premium Kundli',
    pkg_monthly:'/Month', pkg_6month:'/6 Month', pkg_yearly:'/Year',
    rashi_pkg_prefix:'Only ', rashi_pkg_hint:'in Exact Zodiac know',
    ...
    form_info:'Your Information enter (Free Future)',
    lang_label:'Language',
  }
};
