/* ============================================================
   Bhavishya Dekho — lang.js v6.0 COMPLETE FIXED
   Full Hindi→English translation, every button, label, result
...
var H = {
  ...
  'चुनें':'Select','मुफ्त':'Free','पुरुष':'Male','वापस':'Back','नाम':'Name',
  '← वापस':'← Back','▼ और देखें':'▼ See More','▲ कम दिखाएं':'▲ Show Less',
  '20 बार':'20 times','/6 माह':'/6 months','30 बार':'30 times',
  '12 माह':'12 months','लिंग *':'Gender *','10 बार':'10 times',
  'रिपोर्ट':'Report','शुभ अंक':'Lucky Numbers','नक्षत्र':'Nakshatra',
  'वृश्चिक':'Scorpio','एड-फ्री':'Ad-Free','दान करें':'Donate',
  'अपना नाम':'Your Name','व्यक्तिगत':'Personal','शेयर करें':'Share',
  'उपाय नहीं':'No Remedies','आपकी राशि':'Your Zodiac',
  'ग्रह उपाय':'Planetary Remedies','जन्म समय *':'Birth Time *',
  'रत्न सुझाव':'Gemstone Guide','🔮 भविष्यफल':'🔮 Prediction',
  'दोष निवारण':'Dosha Removal','प्राथमिकता':'Priority',
  'लिंग चुनें':'Select Gender','तेज सहायता':'Fast Support',
  'आपका नाम *':'Your Name *','पूरी फ्री +':'All Free +',
  '₹49 — 3 बार':'₹49 — 3 times','संपर्क करें':'Contact Us',
  'बिना रुकावट':'No interruptions','शुभ मुहूर्त':'Auspicious Time',
  '5 बार मुफ्त':'5 times free','3 बार मुफ्त':'3 times free',
  '📲 शेयर करें':'📲 Share','जन्म तिथि *':'Date of Birth *',
  'फ्री भविष्य':'Free Prediction','₹19 — 4 बार':'₹19 — 4 times',
  '4 बार मुफ्त':'4 times free','8 बार मुफ्त':'8 times free',
  'साथी की राशि':'Partner Zodiac','दशा विश्लेषण':'Dasha Analysis',
  '📜 ₹19 कुंडली':'📜 ₹19 Kundli','कुंडली मिलान':'Kundli Matching',
  'लव कैलकुलेटर':'Love Calculator','मासिक राशिफल':'Monthly Horoscope',
  '🗑️ साफ़ करें':'🗑️ Clear','दैनिक राशिफल':'Daily Horoscope',
  'राशिफल देखें':'View Horoscope','जन्म स्थान *':'Birth Place *',
  'मुफ्त कुंडली':'Free Kundli','एड-फ्री अनुभव':'Ad-Free Experience',
  'साथी का नाम *':"Partner's Name *",'जीवन विश्लेषण':'Life Analysis',
  '💳 भुगतान करें':'💳 Make Payment','गोपनीयता नीति':'Privacy Policy',
  '🔮 भविष्य देखें':'🔮 See Future','नियम और शर्तें':'Terms & Conditions',
  'प्रीमियम प्लान':'Premium Plan','दैनिक राशिफल —':'Daily Horoscope —',
  'ग्रहों के उपाय':'Planetary Remedies','तेजी से सहायता':'Fast Support',
  'मुफ्त प्रीमियम':'Free Premium','मुफ्त भविष्य —':'Free Prediction —',
  'वार्षिक राशिफल':'Yearly Horoscope','शुभ अंक और रंग':'Lucky Numbers & Colors',
  'लव कैलकुलेटर —':'Love Calculator —','प्रेम और विवाह':'Love & Marriage',
  'आज का भविष्यफल':"Today's Prediction",'12 भावों का फल':'12 House Results',
  'विस्तृत कुंडली':'Detailed Kundli','👑 ₹49 प्रीमियम':'👑 ₹49 Premium',
  'हमारे बारे में':'About Us','अपनी राशि चुनें':'Select Your Zodiac',
  '🏠 भाव अनुसार फल':'🏠 House Results','सब्सक्राइब करें':'Subscribe',
  '₹19 वाली कुंडली':'₹19 Kundli','जन्म तिथि चुनें':'Select Birth Date',
  'विस्तृत रिपोर्ट':'Detailed Report','प्रीमियम कुंडली':'Premium Kundli',
  'राशि और नक्षत्र':'Zodiac & Nakshatra','₹49 वाली कुंडली':'₹49 Kundli',
  'विशेष रत्न सुझाव':'Special Gemstone Guide','ग्रहों की स्थिति':'Planetary Positions',
  'विशेष उपाय सुझाव':'Special Remedy Guide','कोई रिपोर्ट नहीं':'No Reports Found',
  'महत्वपूर्ण कार्य':'Important Tasks','✨ प्रीमियम प्लान':'✨ Premium Plan',
  '📋 मेरी रिपोर्ट्स':'📋 My Reports','करियर भविष्यवाणी':'Career Prediction',
  'आपके Premium लाभ':'Your Premium Benefits','🔮 कुंडली रिपोर्ट':'🔮 Kundli Report',
  'व्यक्तिगत राशिफल':'Personal Horoscope','प्राथमिकता समर्थन':'Priority Support',
  '🔱 12 भाव (Houses)':'🔱 12 Houses','लव परसेंटेज देखें':'See Love %',
  '₹19 वाली सब कुछ +':'All ₹19 features +','दोष निवारण के उपाय':'Dosha Removal Remedies',
  '📋 विस्तृत भविष्यफल':'📋 Detailed Prediction','संपूर्ण जीवन दर्शन':'Complete Life Reading',
  'सामान्य भविष्यवाणी':'General Prediction','शुभ समय और मुहूर्त':'Auspicious Time & Muhurta',
  ...
  'सिंह (Leo)':'Leo','मेष (Aries)':'Aries','वृष (Taurus)':'Taurus',
  'मिथुन (Gemini)':'Gemini','कर्क (Cancer)':'Cancer','कन्या (Virgo)':'Virgo',
  ...
  'होम':'Home','मासिक राशिफल':'Monthly Horoscope','वार्षिक राशिफल':'Yearly Horoscope',
  'कुंडली मिलान':'Kundli Matching','रत्न सुझाव':'Gemstone Guide',
  'उपाय':'Remedies','मेरी रिपोर्ट्स (हिस्ट्री)':'My Reports (History)',
  ...
  'मेरा भविष्य देखें':'See My Future','मुफ्त भविष्यफल देखें':'Get Free Prediction',
  'आज का भविष्यफल':"Today's horoscope",'जीवन विश्लेषण':'Life Analysis',
  'संपूर्ण जीवन दर्शन':'Complete Life Reading','🔮 भविष्यफल':'🔮 Prediction',
  ...
  '💕 मिलान करें':'💕 Match Now','👰 वधू':'👰 Bride','🤵 वर':'🤵 Groom',
  '🌟 उत्कृष्ट मिलान!':'🌟 Excellent Match!',
  '✅ अच्छा मिलान।':'✅ Good Match.',
  '⚠️ सावधानी आवश्यक।':'⚠️ Caution Advised.',
  'गुण मिलान':'Guna Milan','💎 रत्न सुझाव':'💎 Gemstone Guide',
  'धारण दिन':'Wear Day','मंगलवार':'Tuesday','शुक्रवार':'Friday',
  'बुधवार':'Wednesday','सोमवार':'Monday','रविवार':'Sunday',
  'गुरुवार':'Thursday','शनिवार':'Saturday',
  ...
  'राशि चुनें':'Select Zodiac','अपनी राशि चुनें':'Select Your Zodiac',
  'रोज़ रीसेट':'Daily reset','बचे':'remaining',
  '5 साल का भविष्य':'5-Year Future','अगले 3–6 महीने':'Next 3-6 Months',
  'जीवन टाइमलाइन':'Life Timeline','12 भाव फल':'12 House Results',
  'शुभ कारक':'Lucky Factors','विशेष उपाय':'Special Remedies',
  '📲 दोस्तों के साथ शेयर करें':'📲 Share with friends',
  'नाम *':'Name *','जन्म तिथि':'Date of Birth','जन्म समय':'Birth Time',
  'जन्म स्थान':'Birth Place','लिंग':'Gender',
  'अपना नाम लिखें':'Enter your name',
  'आपका नाम':'Your name','साथी का नाम':"Partner's name",
  'शहर का नाम':'City name','समय':'Time','आयु':'Age','वार':'Weekday',
...
/* MutationObserver — translate content added dynamically (results, modals) */
...
function applyLang(lang){
  ...
  /* Always do a full DOM walk on language switch */
  walkDOM(_isEn);
  applyPricing();
  updateBtns();
...
/* Expose tx() so script.js can translate strings before injecting */
